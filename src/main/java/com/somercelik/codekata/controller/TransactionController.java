package com.somercelik.codekata.controller;
...
public class TransactionController {
    private Transaction createTransaction(String transactionLine) throws ParseException {
        ...
        String[] values = Arrays.stream(transactionLine.split(",")).map(item -> item.trim()).toArray(String[]::new);
